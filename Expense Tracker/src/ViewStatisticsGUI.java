...
/**
 * ViewStatisticsGUI.java is used to handle the GUI for viewing spending statistics for a given date range.
 * user a is able to view metrics such as total spending, number of expenses, and spending by category.
 */
